...
const loginWithGoogle = () => {
  ...
  const options = {
    redirect_uri: `${API_BASE_URL}/login/oauth2/code/google`,
...
const loginWithNaver = () => {
  ...
  const redirectUri = encodeURIComponent(`${API_BASE_URL}/login/oauth2/code/naver`);
...
const loginWithKakao = () => {
  ...
  const redirectUri = encodeURIComponent(`${API_BASE_URL}/login/oauth2/code/kakao`);

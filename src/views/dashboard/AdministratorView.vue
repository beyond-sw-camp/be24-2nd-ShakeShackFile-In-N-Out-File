...
const summaryCards = computed(() => {
  ...
  return [
    { label: "전체 유저", value: `${summary.totalUserCount}명`, tone: "blue" },
    { label: "활성 유저", value: `${summary.activeUserCount}명`, tone: "emerald" },
    { label: "정지 유저", value: `${summary.suspendedUserCount}명`, tone: "amber" },
    { label: "밴 유저", value: `${summary.bannedUserCount}명`, tone: "rose" },
    { label: "전체 사용 용량", value: formatBytes(summary.totalUsedBytes), tone: "slate" },
    { label: "전체 파일 수", value: `${summary.totalFileCount}개`, tone: "indigo" },
    { label: "전체 폴더 수", value: `${summary.totalFolderCount}개`, tone: "sky" },
    { label: "전체 저장 비율", value: formatPercent(summary.overallUsagePercent), tone: "violet" },
  ];
});
  ...
  <div class="admin-page">
    <div class="admin-page__header">
      <div>
        ...
        <p class="admin-page__description">
          전체 유저 통계, 저장 용량 현황, 플랜 분포, 계정 제재 상태를 한 화면에서 관리합니다.
        </p>
      </div>
    ...
    <template v-else-if="dashboard">
      <section class="admin-summary-grid">
        <article v-for="card in summaryCards" :key="card.label" class="admin-card" :data-tone="card.tone">
        ...
        <div class="admin-panel">
          <div class="admin-panel__header">
            <div>
              ...
              <p class="admin-panel__description">관리자 계정은 보호되며, 일반 유저는 활성/정지/밴 상태를 제어할 수 있습니다.</p>
            </div>
          </div>
